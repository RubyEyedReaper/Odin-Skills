...
export function AlertMark({ title, ...props }: AlertMarkProps) {
  ...
  return (
    ...
    >
      ...
      <path fill="#e6142d" d="M55.46 11.63c6.46 5.3 11.7 12.74 12.78 21.25a32.8 32.8 0 0 1-7.5 22.56c-5.46 5.76-12.28 8.63-20.18 8.9-9.04.14-15.72-.86-22.61-7.24C11.43 50.05 9.03 43.58 9 34c.65-8.64 5.08-15.47 11.25-21.37 9.84-7.81 24.9-7.84 35.2-1" />
