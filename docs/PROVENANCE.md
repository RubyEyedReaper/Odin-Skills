...
| `test-driven-development` | [obra/superpowers](https://github.com/obra/superpowers) | MIT | `b36e082` | Local `testing-anti-patterns.md` retained; upstream has since replaced that prose with its own `writing-good-tests.md` |
